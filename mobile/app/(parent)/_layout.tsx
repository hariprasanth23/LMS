...
export default function ParentTabsLayout() {
  ...
  return (
    <Tabs
      screenOptions={{
        headerShown: false,
        tabBarActiveTintColor: PORTAL_COLORS.PARENT,
    ...
    >
      ...
      <Tabs.Screen name="attendance" options={{ title: 'Attendance', tabBarIcon: ({ color, size }) => <MaterialIcons name="event-available" color={color} size={size} /> }} />
      <Tabs.Screen name="results" options={{ title: 'Results', tabBarIcon: ({ color, size }) => <MaterialIcons name="grade" color={color} size={size} /> }} />
      <Tabs.Screen name="fees" options={{ title: 'Fees', tabBarIcon: ({ color, size }) => <MaterialIcons name="payments" color={color} size={size} /> }} />
